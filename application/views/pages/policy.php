...
<div class="container">
  <div class="policy">
    <div class="row">
      <div class="col-md-4">
        <img class="img-cert" src="<?php echo base_url() ?>assets/images/awards/web_certificateA.jpg" alt="" >
        <br><br>
        <img class="img-cert" src="<?php echo base_url() ?>assets/images/awards/web_certificateB.jpg" alt="" >
      </div>
      <div class="col-md-8">
