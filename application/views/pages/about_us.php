  ...
  <!-- /top navigation -->
      ...
      <div class="vision">
        <div class="row">
          ...
          <div class="col-md-6 vision-img">
            <img height="100%" class="card-img-top mx-auto" src="<?php echo base_url() ?>assets/images/reliable_quality.jpg" alt="Card image cap">
          </div>
        </div>
      </div>
      <hr>
    ...
    <div class="container" id="tabs">
      <div class="performance">
        <h1 class="title mb-5">Performance</h1>
        <div class="row">
    			<div class="col-xs-12 ">
    				<nav>
