...
<div class="container-fluid" id="certi-head">
  <div class="sub-page-heading">
    <h1 class="sub-page-title"><span>Quality Policy</span></h1>
  </div>
</div>
...
<div class="container">
  <div class="policy">
    <div class="row">
      <div class="col-md-4">
        <img class="img-cert" src="<?php echo base_url() ?>assets/images/certificate1.jpg" alt="" >
        <br><br>
        <img class="img-cert" src="<?php echo base_url() ?>assets/images/certificate3.jpg" alt="" >
      </div>
      <div class="col-md-8">
<p class="ml-45"> We at RIPL, are aware that our growth and success depends upon our valuable customer relationships. Thus we have committed ourselves to manufacture and deliver products to the utmost satisfaction of the customers by continually improving our Quality Management System.</p>
<ul class="pilicy-ul">
